...
exec gunicorn wesalvator.wsgi:application --bind 0.0.0.0:8000 --workers 4 --timeout 120 --access-logfile -
...
echo "Starting Gunicorn server..."
exec gunicorn wesalvator.wsgi:application --bind 0.0.0.0:8000 --workers 4
